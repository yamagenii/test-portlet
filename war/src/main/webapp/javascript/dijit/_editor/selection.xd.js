...
depends: [["provide", "dijit._editor.selection"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit._editor.selection"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
