...
depends: [["provide", "dijit._base.wai"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit._base.wai"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
