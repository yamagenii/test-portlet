...
depends: [["provide", "dijit.InlineEditBox"],
["require", "dojo.i18n"],
...
defineResource: function(dojo){if(!dojo._hasResource["dijit.InlineEditBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
