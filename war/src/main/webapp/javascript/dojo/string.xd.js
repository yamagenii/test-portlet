...
depends: [["provide", "dojo.string"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.string"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
