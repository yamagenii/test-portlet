...
depends: [["provide", "dojo.behavior"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.behavior"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
