...
depends: [["provide", "dojo.NodeList-fx"],
["require", "dojo.fx"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.NodeList-fx"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
