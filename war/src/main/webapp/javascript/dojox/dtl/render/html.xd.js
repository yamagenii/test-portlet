...
depends: [["provide", "dojox.dtl.render.html"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.dtl.render.html"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
