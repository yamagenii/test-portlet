...
depends: [["provide", "dojox.dtl._base"],
["require", "dojox.string.Builder"],
["require", "dojox.string.tokenize"],
["requireIf", true, require],
["require", "dojox.string.Builder"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.dtl._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
