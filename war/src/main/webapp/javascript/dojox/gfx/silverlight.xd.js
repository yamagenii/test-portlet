...
depends: [["provide", "dojox.gfx.silverlight"],
["require", "dojox.gfx._base"],
["require", "dojox.gfx.shape"],
["require", "dojox.gfx.path"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.gfx.silverlight"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
