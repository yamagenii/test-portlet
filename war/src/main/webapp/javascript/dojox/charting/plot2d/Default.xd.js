...
depends: [["provide", "dojox.charting.plot2d.Default"],
...
defineResource: function(dojo){if(!dojo._hasResource["dojox.charting.plot2d.Default"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
