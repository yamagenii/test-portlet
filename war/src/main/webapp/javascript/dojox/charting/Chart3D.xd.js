...
depends: [["provide", "dojox.charting.Chart3D"],
["require", "dojox.gfx3d"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.charting.Chart3D"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
