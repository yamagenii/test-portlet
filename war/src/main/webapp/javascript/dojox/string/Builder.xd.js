...
depends: [["provide", "dojox.string.Builder"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.string.Builder"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
