...
depends: [["provide", "dojox.grid._grid.views"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.grid._grid.views"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
