...
depends: [["provide", "dojox.grid._grid.rows"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.grid._grid.rows"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
