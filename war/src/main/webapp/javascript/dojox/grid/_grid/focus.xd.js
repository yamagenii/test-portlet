...
depends: [["provide", "dojox.grid._grid.focus"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.grid._grid.focus"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
