...
depends: [["provide", "dojox.layout.BorderContainer"],
["require", "dijit.layout._LayoutWidget"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.layout.BorderContainer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
