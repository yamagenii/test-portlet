...
depends: [["provide", "dojox.layout.RadioGroup"],
...
defineResource: function(dojo){if(!dojo._hasResource["dojox.layout.RadioGroup"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
